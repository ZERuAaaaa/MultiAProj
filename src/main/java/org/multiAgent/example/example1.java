...
import org.multiAgent.Models.ModestyModel;
...
public class example1 {
    ...
    public static void main(String[] args) {
        ...
        SocialWelfareModel socialWelfareModel = new SocialWelfareModel();
        ModestyModel modestyModel = new ModestyModel();

        dialogue.addAgent(audience1, arguments1, nashModel);
        dialogue.addAgent(audience2, arguments2, socialWelfareModel);
        dialogue.addAgent(audience3,arguments3, modestyModel);
        dialogue.run("go out");
    }
}
