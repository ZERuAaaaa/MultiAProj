...
public class example1 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        int ROUNDS = 1000;
        File writeFile = new File("C:\\Users\\moyuq\\Desktop\\Dialogue_System\\src\\main\\java\\org\\multiAgent\\data\\writeSucess.csv");
        File writeFile1 = new File("C:\\Users\\moyuq\\Desktop\\Dialogue_System\\src\\main\\java\\org\\multiAgent\\data\\writeSucess1");
            ...
            for (int VALUES = 2; VALUES < 10 ; VALUES += 2){
                for (int ACTIONS = 2; ACTIONS < 10; ACTIONS += 2){
                    for (int ARGUMENTS = 2; ARGUMENTS <= VALUES * ACTIONS * 2; ARGUMENTS += 2 ){
                        ...
                        writeText.newLine();
                        writeText.write(AGENTS + "," + VALUES +","+ ACTIONS+"," + ARGUMENTS +","+ lengthA / ROUNDS+"," + dialogueSucessA / ROUNDS+"," + consensusSucessA / ROUNDS+"," + dialogueScoreA / dialogueSucessA+"," +  consensusScoreA / consensusSucessA);
                        writeText1.newLine();
                        writeText1.write(AGENTS + "," +VALUES +","+ ACTIONS+"," + ARGUMENTS +","+ lengthB / ROUNDS+"," + dialogueSucessB / ROUNDS+"," + consensusSucessB / ROUNDS+"," + dialogueScoreB / dialogueSucessB+"," +  consensusScoreB / consensusSucessB);
                    }
                }
            }
        }
